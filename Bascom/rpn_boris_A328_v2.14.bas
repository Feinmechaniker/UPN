...
$framesize = 196                                            ' default use 40 for the frame space
...
Sub Polling()
  ...
  Else
      ...
      End If
         ...
         If Is_ziffer = 1 Then                              ' Eine Ziffer wurde gedrueckt, das kenn adresse oder Eingabe sein
            ...
            Else                                            ' Adresseingabe
                ...
                End If
            End If
         Else                                               ' Keine Ziffer, ein Kommando
...
Function Exec_kdo() As Byte
    ...
    Select Case X_kommando
      ...
      Case K_roll                                           ' Roll Down
         ...
         Rt = Lstx
      Case K_store                                          ' STO
         L_adr = X_adresse + 1                              ' In BASCOM geht der Index ab 1
         If L_adr > 0 And X_adresse < 11 Then
            Ce_mem(l_adr) = Rx
