...
Const Dfilesystemstatusfat = 0                              ' 0 = FAT16, 1 = FAT32
Const Dfilesystemsubdir = 1                                 ' 0 = Root-Directory, 1 = Sub-Directory
...
Const Dfatsecondupdate = 7                                  ' Bit-position for parameter of
                                                             ' Update second FAT in gbFileSystemStatus


' Bit Definitions for BufferStatus (FAT, DIR, File)

Const Deof = 1 : Const Dmeof =(2 ^ Deof)
Const Deofinsector = 2 : Const Dmeofinsector =(2 ^ Deofinsector)
Const Dwritepending = 3 : Const Dmwritepending =(2 ^ Dwritepending)
Const Dfatsector = 4 : Const Dmfatsector =(2 ^ Dfatsector)  ' For Writing Sector back (FATNumber times)
Const Dfileempty = 5 : Const Dmfileempty =(2 ^ Dfileempty)

' New feature for reduce saving
Const Dfatdirwritepending = 6 : Const Dmfatdirwritepending =(2 ^ Dfatdirwritepending)
Const Dfatdirsaveatend = 7 : Const Dmfatdirsaveatend =(2 ^ Dfatdirsaveatend)
Const Dfatdirsaveanyway = 0 : Const Dmfatdirsaveanyway =(2 ^ Dfatdirsaveanyway)
